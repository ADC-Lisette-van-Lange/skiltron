...
4. Geef een geordende lijst terug met de relevante skills. Geef per skill:
   ...
   - **Waarmee helpt deze skill**: gebruik het format `[Type output] - [beschrijving]` op basis van de tabel in de sectie **Output van elke skill** onderaan dit bestand. Bijvoorbeeld: `Controlelijst + Wegwijzer - Antwoorden op screeningvragen, een dossieropzet, en doorverwijzing naar de FG en juridisch adviseur`. Pas de beschrijving aan op de specifieke use case.
